<template>
  <MainLayout>
    <div
      class="pt-[50px] 2xl:pl-[185px] lg:pl-[160px] lg:pr-0 pr-2 w-[calc(100%-90px)] max-w-[1800px] 2xl:mx-auto"
    >
      <div class="flex w-[calc(100vw-230px)]">
        ...
        <div class="ml-5 w-full">
          ...
          >
            <Icon class="mt-0.5 mr-1" name="mdi:pencil" size="18"></Icon>
            <div>Edit profile</div>
          </button>

          <button
            v-else
            class="flex item-center rounded-md py-1.5 px-8 mt-3 text-[15px] font-semibold text-white border bg-[#F02C56]"
          >
            Follow
          </button>
        </div>
      ...
      <div class="w-full flex items-center pt-4 border-b">
        ...
        <div
          class="w-60 text-gray-500 text-center py-2 text-[17px] font-semibold flex items-center justify-center gap-1"
        >
          <Icon class="text-[17px]" name="material-symbols:lock-open"></Icon>
          Liked
        </div>
      </div>
