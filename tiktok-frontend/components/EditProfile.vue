<template>
  ...
  >
    <div
      class="relative bg-white w-full max-w-[700px] sm:h-[580px] mx-3 rounded-lg mb-10"
    ...
    >
      ...
      >
        ...
        <div v-else class="w-full h-[430px] px-2">
          <Cropper
      ...
      <div
        id="ButtonSection"
        class="absolute p-2 left-0 bottom-0 border-t border-t-gray-300 w-full"
      >
        <div
